        ...
        <div className="bg-slate-900/85 border border-slate-800/90 backdrop-blur-xl rounded-3xl p-7 shadow-2xl space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2 pt-1">
            <button
              ...
              className="bg-white hover:bg-slate-100 text-slate-900 rounded-xl py-2 px-2 text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-md"
            >
            ...
            <button
              ...
              className="bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-xl py-2 px-2 text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-md"
            >
            ...
            <button
              ...
              className="bg-[#1877F2] hover:bg-[#166fe5] text-white border border-blue-600 rounded-xl py-2 px-2 text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-md"
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="shrink-0 text-white">
