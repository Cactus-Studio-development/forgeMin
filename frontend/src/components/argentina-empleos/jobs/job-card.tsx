      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {job.isVerifiedCompany && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-emerald-50 text-emerald-800 border border-emerald-200 text-[11px] font-bold">
          ...
          {/* Women Only Tag */}
          {job.isWomenOnly && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-pink-50 text-pink-800 border border-pink-200 text-[11px] font-bold">
          ...
          {/* Private Tag */}
          {job.isPrivate && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-purple-50 text-purple-800 border border-purple-200 text-[11px] font-semibold">
          ...
          {job.hasTermsAgreement && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-amber-50 text-amber-800 border border-amber-200 text-[11px] font-semibold">
      ...
      <div className="mb-3">
        ...
        <div className="flex items-center gap-3 text-xs text-slate-600 font-medium mt-1">
          <div className="flex items-center gap-1">
            ...
            {job.isVerifiedCompany && (
              <span title="Empresa Verificada Oficial">
